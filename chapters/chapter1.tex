...
protons, and neutral neutrons) is positively charged, and so two atoms' nuclei will repel each other when pushed together. This is the force 
we have to overcome to enable a fusion reaction to take place (and what stops the world around us burning!). 
...
In reality, reactors do not often have such nice geometry. Figure \ref{east-geometry}
\begin{figure}[h!]
    \centering
